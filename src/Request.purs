...
import Common (AuthCode(..), Content(..), GistID(..), Token(..), tokenServerUrl)
...
ghRequestToken :: AuthCode -> Aff (Either String Token)
    ...
    $ case result of
        ...
        Right response -> do
          ...
          case decodeJson response.body of
            ...
            Right (decoded :: TokenResp) -> Right $ Token decoded.access_token
...
ghCreateGist :: Token -> Content -> Aff (Either String GistID)
